...
function Home() {
  ...
  return (
    <>
      {calculator ? <ModulsCalculator visble={calculator} onrequewt={setCalculator} onprssfounction={() => null} /> : null}
      ...
      <PagerView style={styles.pages} initialPage={0}>
        <Tap.Navigator
          ...
          <Tap.Screen name="Contracting" component={Contracting}
            options={{
              header: () => null,
            }}
          />
          <Tap.Screen
            name="Profile" component={My_profile}
            options={{
              header: () => {
                return (
                  <View style={{ marginHorizontal: RFValue(15), marginVertical: RFValue(10), flexDirection: locale === 'ar_MA' ? 'row' : 'row-reverse', justifyContent: 'space-between' }}>
                    <Text style={{
                      fontSize: 20,
                      flex:1.5 ,
                    ...
                    <View style={{ alignItems: 'center', justifyContent: 'space-around', flexDirection: 'row', flex: 0.8 }}>
                    <Pressable android_ripple={{ color: colors.YALO, borderless: true }} style={{height:RFValue(40),width:RFValue(50),justifyContent:"center",alignItems:'center',marginHorizontal:5}} onPress={() => setCalculator(true)}>
                        <FontAwesome5Icon name='calculator' size={20} color={colors.GREYD} />
                      </Pressable>
                      <TouchableOpacity style={{height:RFValue(40),width:RFValue(50),justifyContent:"center",alignItems:'center',marginHorizontal:5 }} onPress={() => setBellmodels(true)} >
                        <FontAwesome5 style={{ height: 25, }} name="phone" color={colors.CURRENT} size={18} />
                      </TouchableOpacity>
                    </View>
